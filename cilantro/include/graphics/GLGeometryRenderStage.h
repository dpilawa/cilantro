...
protected:
    ...
    virtual std::string GetMeshObjectGeometryShaderProgram (const MeshObject& meshObject) = 0;
    virtual std::string GetMeshObjectLightingShaderProgram (const MeshObject& meshObject) = 0;
