...
renderer.CreateSurfaceRenderStage ("hdr_postprocess").SetShaderProgram ("post_hdr_shader").SetColorAttachmentsFramebufferLink (c.PipelineLink.LINK_PREVIOUS);
renderer.CreateSurfaceRenderStage ("fxaa_postprocess").SetShaderProgram ("post_fxaa_shader").SetRenderStageParameterFloat ("fMaxSpan", 4.0).SetRenderStageParameterVector2f ("vInvResolution", c.Vector2f (1.0 / renderer.GetWidth (), 1.0 / renderer.GetHeight ())).SetColorAttachmentsFramebufferLink (c.PipelineLink.LINK_PREVIOUS)
renderer.CreateSurfaceRenderStage ("gamma_postprocess+screen").SetShaderProgram ("post_gamma_shader").SetRenderStageParameterFloat ("fGamma", 2.1).SetColorAttachmentsFramebufferLink (c.PipelineLink.LINK_PREVIOUS).SetFramebufferEnabled (False)
